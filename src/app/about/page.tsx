...
export default function AboutUsPage() {
  return (
    <div className="container mx-auto px-6 py-16">
      <h1 className="text-2xl md:text-5xl font-bold text-center text-gray-800 mb-12">About Us</h1>

      <div className="flex flex-col lg:flex-row items-center lg:space-x-12 mb-16">
        <div className="lg:w-1/2 mb-8 lg:mb-0">
          <h2 className="text-xl md:text-4xl font-bold text-gray-800 mb-6">Your Adventure Architects in the UAE</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
        <div className="bg-gray-50 p-4 md:p-8 rounded-lg shadow-lg">
          <h3 className="text-2xl md:text-4xl font-bold text-blue-600 mb-2">5,000+</h3>
          <p className="text-sm md:text-xl text-gray-700">Top Destinations</p>
        </div>
        <div className="bg-gray-50 p-4 md:p-8 rounded-lg shadow-lg">
          <h3 className="text-2xl md:text-4xl font-bold text-blue-600 mb-2">3,000+</h3>
          <p className="text-sm md:text-xl text-gray-700">Bookings Completed</p>
        </div>
        <div className="bg-gray-50 p-4 md:p-8 rounded-lg shadow-lg">
          <h3 className="text-2xl md:text-4xl font-bold text-blue-600 mb-2">11,000+</h3>
          <p className="text-sm md:text-xl text-gray-700">Satisfied Clients</p>
        </div>
      </div>
    </div>
  );
